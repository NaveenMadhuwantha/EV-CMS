      ...
      <div className="p-8 border-b border-white/5">
        <Link to="/owner/dashboard" className="flex items-center gap-4 group">
          ...
          <div>
            ...
            <div className="text-[10px] text-[#4E7A96] uppercase tracking-[3px] mt-2 font-bold whitespace-nowrap opacity-60">User Portal</div>
          </div>
        </Link>
      </div>
...
const Topbar = ({ title }) => (
  <header className="sticky top-0 z-50 h-[80px] bg-[#050c14]/80 backdrop-blur-2xl border-b border-white/5 flex items-center px-12 gap-8 font-inter shadow-sm">
    ...
    <div className="flex items-center gap-4 bg-white/[0.03] border border-white/5 rounded-2xl px-5 py-3 w-[320px] focus-within:border-[#00d2b4]/40 transition-all group shadow-inner">
      ...
      <input type="text" placeholder="Search Map..." className="bg-transparent border-none outline-none text-[13px] text-white w-full placeholder:text-[#4E7A96] placeholder:uppercase placeholder:tracking-widest placeholder:text-[9px] font-bold" />
    </div>
