...
const ProviderRegisterStep5 = () => {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#050F1C] text-white selection:bg-blue-500/30 overflow-x-hidden font-inter">
      <ProvSidebar activeStep={5} />
