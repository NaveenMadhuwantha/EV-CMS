...
const ProviderRegisterStep3 = () => {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#FDF8EE] text-[#0F172A] selection:bg-amber-500/30 overflow-x-hidden font-inter">
      <ProvSidebar activeStep={3} />
